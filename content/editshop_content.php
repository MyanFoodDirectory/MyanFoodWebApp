<div class="container shop_content">
  ...
  <h1 class="h1-responsive text-center" style="margin-bottom: 30px;color:#CC0000;text-shadow: 2px 2px 2px #667eaa;">Shop Edit</h1>
  ...
  <div class="row">
    ...
    <div class="col-sm-6">
      <button type="button" class="btn btn-danger btn-lg btn-block btn-shop">Delete</button>
    </div>
    ...
    <div class="col-sm-6">
      ...
      <div class="row">
          ...
          <button type="button" class="btn btn-info btn-shop col-md-3 col-md-offset-4">Cancel</button>
        
          <button type="button" class="btn btn-info btn-shop col-md-3 col-md-offset-1">Submit</button>
